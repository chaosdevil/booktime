...
class ProductTagManager(models.Manager):
    """docstring for ProductTagManager"""
...
class Basket(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, default=OPEN)
    ...
    def create_order(self, billing_address, shipping_address):
        ...
        logger.info(
            "Creating order for basket_id={0}, shipping_address_id={1}, billing_address_id={2}".
            format(self.id, shipping_address.id, billing_address.id))
