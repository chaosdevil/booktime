...
class TestImport(TestCase):
    # creating a new temporary folder as MEDIA_ROOT
    # dealing with potentially many uploaded files
    # Using a temporary folder makes sure this will be
    # eventually cleaned by the operating system
