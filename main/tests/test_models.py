...
class TestModel(TestCase):
    ...
    #         user=user1,
    #         name='Sura Wankam',
    #         address1='71 Soi Liang Mueang Nonthaburi 3',
    #         city='Nonthaburi',
    #         country='uk'
    #     )
    ...
    #     self.assertEquals(order.billing_address1, '71 Soi Liang Mueang Nonthaburi 3')
    #     self.assertEquals(order.shipping_address1, '71 Soi Liang Mueang Nonthaburi 3')
