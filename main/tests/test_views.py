...
class TestPage(TestCase):
    ...
    def test_product_page_filters_by_tags_and_active(self):
        # create product objects
        cb = models.Product.objects.create(
            name='The cathedral and the bazaar',
            slug='cathe100dral-bazaar',
            price=Decimal('10.00')
        )
        # add a tag to 'the cathedral and the bazaar'
        ...
        # get url products/slug:opensource
    ...
    def test_address_list_page_returns_only_owned(self):
        ...
        models.Address.objects.create(
            ...
            name='Sura Wankam',
            address1='71',
            address2='Soi Liang Mueang Nonthaburi',
            city='London',
            country='uk'
        )
        models.Address.objects.create(
    ...
    def test_address_create_stores_user(self):
        ...
        post_data = {
            'name': 'Sura Wankam',
            'address1': '71 Soi Liang Mueang Nonthaburi',
            'address2': '',
            'zip_code': '11000',
            'city': 'Manchester',
            'country': 'uk'
    ...
    def test_add_to_basket_login_merge_works(self):
        ...
        self.client.post(
            reverse('login'),
            {'email': 'user1@domain.com', 'password': 'password'}
        )
        ...
        self.assertTrue(
            models.Basket.objects.filter(user=user1)
        )
